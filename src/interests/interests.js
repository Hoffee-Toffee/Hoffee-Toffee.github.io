...
var loadFunc = function () {
  ...
  interests.onscroll = function () {
    ...
    if (fgImgs.includes(document.getElementById('isaac-clarke'))) {
      ...
      // Down-in & Up-out
      if (
        scrollPosition >= viewportHeight / 2 - fgImg.offsetHeight / 2 &&
        scrollPosition <= viewportHeight / 2 + fgImg.offsetHeight / 2
      ) {
      ...
      // Down-out & Up-in
        ...
        scrollPosition > viewportHeight / 2 + fgImg.offsetHeight / 2 &&
        scrollPosition < viewportHeight / 2 + fgImg.offsetHeight
      ) {
        fgImg.style.opacity =
          1 -
          (scrollPosition - (viewportHeight / 2 + fgImg.offsetHeight / 2)) /
    ...
    if (fgImgs.includes(document.getElementById('tony-stark'))) {
      ...
      if (
        ...
        scrollPosition <= viewportHeight * 1.5 + fgImg.offsetHeight * 1.5
      ) {
    ...
    if (fgImgs.includes(document.getElementById('neuralink-robot'))) {
      // Neuralink Robot
      // Like Stark
    ...
    if (fgImgs.includes(document.getElementById('starfleet-logo'))) {
      // Starfleet Logo
      // Like Stark
      var fgImg = document.getElementById('starfleet-logo')
      // Down-in & Up-out & Down-out & Up-in
      if (
        scrollPosition >= viewportHeight * 5.5 - fgImg.offsetHeight / 2 &&
        scrollPosition <= viewportHeight * 5.5 + fgImg.offsetHeight * 2.5
      ) {
    ...
    if (fgImgs.includes(document.getElementById('tetronimos'))) {
      ...
      // Down-in & Up-out & Down-out & Up-in
      if (
        scrollPosition >= viewportHeight * 6.5 - fgImg.offsetHeight / 2 &&
        scrollPosition <= viewportHeight * 6.5 + fgImg.offsetHeight * 2.5
      ) {
    ...
    if (fgImgs.includes(document.getElementById('memento'))) {
      ...
      // Down-in & Up-out & Down-out & Up-in
      if (
        scrollPosition >= viewportHeight * 7.5 - fgImg.offsetHeight / 2 &&
        scrollPosition <= viewportHeight * 7.5 + fgImg.offsetHeight * 2.5
      ) {
    ...
    if (
      scrollPosition >=
        document.getElementById('interests-end').offsetTop - viewportHeight &&
      scrollPosition <= document.getElementById('interests-end').offsetTop
    ) {
      footer.style.opacity =
        1 -
        ((document.getElementById('interests-end').offsetTop - scrollPosition) /
          viewportHeight) *
          5
